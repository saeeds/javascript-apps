function $(slector, container){
    return (container || document).querySelector(slector);
}
        ...
        createGrid: function(){
            ...
            for(var y=0; y <this.size; y++){
             ...
             this.grid.addEventListener('change', function(evt){
                 if(evt.target.nodeName.toLocaleLowerCase() == 'input'){
                     me.started = false;
                 }
             });
             ...
             this.grid.addEventListener('keyup', function(evt){
                ...
                if(checkbox.nodeName.toLocaleLowerCase() == 'input'){
